  ...
  return (
    <div className="bg-white mt-12 py-16 px-8 flex flex-col lg:flex-row items-center lg:items-start justify-between">
      ...
      <div className="lg:w-1/2 w-full mt-6">
        ...
        <img src="https://res.cloudinary.com/luxuryp/images/w_960,c_limit,f_auto,q_auto/vrzgavgxfcnihkvupzqn/sitting" alt="About" className="w-full h-auto object-cover" />
      </div>
    </div>
  );
};
